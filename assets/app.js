/* ==========================================================================
   ...
   Loaded on every page via <script src="assets/app.js">.
...
const NAV = [
  { key: "dashboard", label: "Dashboard", icon: "dashboard", href: "dashboard.html" },
  {
    ...
    children: [
      { key: "students", label: "All Students", href: "students.html" },
      { key: "student-add", label: "Add Student", href: "student-add.html" },
      { key: "student-id-cards", label: "Student ID Cards", href: "student-id-cards.html" },
    ],
  },
  {
    key: "staff", label: "Staff", icon: "badge",
    children: [
      { key: "staff", label: "All Staff", href: "staff.html" },
      { key: "teachers", label: "Teachers", href: "teachers.html" },
      { key: "departments", label: "Departments", href: "departments.html" },
      { key: "designations", label: "Designations", href: "designations.html" },
    ],
  },
  {
    key: "academics", label: "Academics", icon: "school",
    children: [
      { key: "academic-years", label: "Academic Years", href: "academic-years.html" },
      { key: "classes", label: "Classes", href: "classes.html" },
      { key: "sections", label: "Sections", href: "sections.html" },
  ...
  },
  {
    ...
    children: [
      { key: "attendance-daily", label: "Daily Attendance", href: "attendance-daily.html" },
      { key: "attendance-reports", label: "Attendance Reports", href: "attendance-reports.html" },
    ],
  },
  {
    key: "examinations", label: "Examinations", icon: "quiz",
    children: [
      { key: "exams", label: "Exams", href: "exams.html", soon: true },
      { key: "results", label: "Results", href: "results.html", soon: true },
    ],
  },
  {
    key: "fees", label: "Fees", icon: "payments",
    children: [
      { key: "fee-dashboard", label: "Fee Dashboard", href: "fee-dashboard.html" },
      { key: "fee-structure", label: "Fee Structure", href: "fee-structure.html", soon: true },
      { key: "student-fees", label: "Student Fees", href: "student-fees.html", soon: true },
      { key: "fee-collection", label: "Fee Collection", href: "fee-collection.html", soon: true },
    ],
  },
  {
    key: "homework", label: "Homework", icon: "assignment",
    children: [
      { key: "homework-assignments", label: "Assignments", href: "homework-assignments.html", soon: true },
      { key: "homework-submissions", label: "Submissions", href: "homework-submissions.html", soon: true },
    ],
  },
  {
    key: "communication", label: "Communication", icon: "campaign",
    children: [
      { key: "notices", label: "Notices", href: "notices.html" },
      { key: "announcements", label: "Announcements", href: "announcements.html" },
    ],
  },
  { key: "leave-management", label: "Leave Management", icon: "event_busy", href: "leave-management.html", soon: true },
  { key: "transport", label: "Transport", icon: "directions_bus", href: "transport.html", soon: true },
  { key: "certificates", label: "Certificates", icon: "workspace_premium", href: "certificates.html" },
  { key: "reports", label: "Reports", icon: "bar_chart", href: "reports.html" },
  { key: "user-management", label: "User Management", icon: "manage_accounts", href: "user-management.html" },
...
function renderNavItem(item, activeKey, openKey) {
  ...
  if (item.children) {
    ...
    const childrenHtml = item.children
      .map((c) => {
        ...
        return `
        <a href="${c.href}" class="flex items-center justify-between pl-11 pr-3 py-2 rounded-lg text-body-md font-body-md transition-colors
  ...
  return `
    <a href="${item.href}" class="flex items-center justify-between px-3 py-2.5 rounded-lg text-body-md font-body-md transition-colors
      ${active ? "bg-primary-fixed text-primary font-medium" : "text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface"}">
      <span class="flex items-center gap-3">
        ${iconSpan(item.icon, "text-[20px]")}
        <span class="sidebar-label truncate">${item.label}</span>
...
function renderSidebar(activeKey) {
  ...
  <aside id="app-sidebar"
    ...
    <div class="h-16 flex items-center gap-3 px-4 border-b border-outline-variant/60 shrink-0">
      ...
      <a href="dashboard.html" class="sidebar-label font-headline-md text-headline-md text-primary truncate">EduCore</a>
    ...
    <div class="border-t border-outline-variant/60 p-3">
      <a href="login.html" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-body-md font-body-md text-on-surface-variant hover:bg-error-container hover:text-on-error-container transition-colors">
    ...
    <div class="ml-auto flex items-center gap-1.5 shrink-0">
      ...
      <div class="relative">
        ...
        <div id="profile-menu" class="hidden absolute right-0 mt-2 w-56 rounded-xl border border-outline-variant/60 bg-surface-container-lowest shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08)] py-2 z-30">
          ...
          <a href="settings.html" class="flex items-center gap-2.5 px-3.5 py-2 text-body-md font-body-md text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface">${iconSpan("settings", "text-[18px]")} School Settings</a>
          <a href="user-management.html" class="flex items-center gap-2.5 px-3.5 py-2 text-body-md font-body-md text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface">${iconSpan("manage_accounts", "text-[18px]")} User Management</a>
          <div class="my-1 border-t border-outline-variant/60"></div>
          <a href="login.html" class="flex items-center gap-2.5 px-3.5 py-2 text-body-md font-body-md text-error hover:bg-error-container/40">${iconSpan("logout", "text-[18px]")} Log Out</a>
        </div>
      </div>
    </div>
  </header>`;
